...
<div>
	<div class="goods">
		...
		<shopcart ref="shopcart" :selectGoods="selectFoods" :delivery-price="seller.deliveryPrice" :min-Price="seller.minPrice"></shopcart>
	</div>
...
export default{
  ...
  methods: {
    ...
    _drop(target) {
      // 异步执行下落动画，优化体验 在下次 DOM 更新循环结束之后执行延迟回调
      this.$nextTick(() => {
